...
const Card = () => {
    ...
    useEffect(() => {
        // console.log('hellow form useEffect!')
        ...
        <>
         <span onClick={handleSort}><Button>Sort by Date</Button></span>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:px-12 my-6'>
                ...
                {
                    data.slice(0, showAll ? data.length : 6).map((singleData) => <SingleData singleData={singleData} key={singleData.id} setUniqueId={setUniqueId} />)
                }
            </div>
            {
